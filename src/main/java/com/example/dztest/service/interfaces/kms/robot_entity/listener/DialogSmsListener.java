...
@Slf4j
@Component(value = "l10")
public class DialogSmsListener implements ReadListener<DialogSms> {
    private String flag = "";
    private static final int BATCH_COUNT = 100;
    private List<DialogSms> cachedDataList = ListUtils.newArrayListWithExpectedSize(BATCH_COUNT);
    private DialogSms ob;
    private List<String> sheetDataList = new ArrayList<>();

    public DialogSmsListener() {
        ob = new DialogSms();
    }

    public DialogSmsListener(String flag) {
        ob = new DialogSms();
        this.flag = flag;
    }

    public DialogSmsListener(DialogSms ob) {
        this.ob = ob;
    }

    @Override
    public void invoke(DialogSms data, AnalysisContext context) {
