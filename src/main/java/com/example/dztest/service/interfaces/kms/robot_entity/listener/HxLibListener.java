...
@Slf4j
@Component(value = "l1")
public class HxLibListener implements ReadListener<HxLib> {
    private String flag = "";
    private static final int BATCH_COUNT = 100;
    private List<HxLib> cachedDataList = ListUtils.newArrayListWithExpectedSize(BATCH_COUNT);
    private HxLib ob;
    private List<String> sheetDataList = new ArrayList<>();

    public HxLibListener() {
        ob = new HxLib();
    }

    public HxLibListener(String flag) {
        ob = new HxLib();
        this.flag = flag;
    }

    public HxLibListener(HxLib ob) {
        this.ob = ob;
    }

    @Override
    public void invoke(HxLib data, AnalysisContext context) {
