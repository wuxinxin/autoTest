...
@Slf4j
@Component(value = "l8")
public class TaskProcessListener implements ReadListener<TaskProcess> {
    private String flag = "";
    private static final int BATCH_COUNT = 100;
    private List<TaskProcess> cachedDataList = ListUtils.newArrayListWithExpectedSize(BATCH_COUNT);
    private TaskProcess ob;
    private List<String> sheetDataList = new ArrayList<>();

    public TaskProcessListener() {
        ob = new TaskProcess();
    }

    public TaskProcessListener(String flag) {
        ob = new TaskProcess();
        this.flag = flag;
    }

    public TaskProcessListener(TaskProcess ob) {
        this.ob = ob;
    }

    @Override
    public void invoke(TaskProcess data, AnalysisContext context) {
