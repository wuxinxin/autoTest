...
@Slf4j
@Component(value = "l7")
public class TableKnowledgeListener implements ReadListener<TableKnowledge> {
    private String flag = "";
    private static final int BATCH_COUNT = 100;
    private List<TableKnowledge> cachedDataList = ListUtils.newArrayListWithExpectedSize(BATCH_COUNT);
    private TableKnowledge ob;
    private List<String> sheetDataList = new ArrayList<>();

    public TableKnowledgeListener() {
        ob = new TableKnowledge();
    }

    public TableKnowledgeListener(String flag) {
        ob = new TableKnowledge();
        this.flag = flag;
    }

    public TableKnowledgeListener(TableKnowledge ob) {
        this.ob = ob;
    }

    @Override
    public void invoke(TableKnowledge data, AnalysisContext context) {
