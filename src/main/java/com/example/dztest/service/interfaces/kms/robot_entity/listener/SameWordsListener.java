...
@Slf4j
@Component(value = "l2")
public class SameWordsListener implements ReadListener<SameWords> {
    private String flag = "";
    private static final int BATCH_COUNT = 100;
    private List<SameWords> cachedDataList = ListUtils.newArrayListWithExpectedSize(BATCH_COUNT);
    private SameWords ob;
    private List<String> sheetDataList = new ArrayList<>();

    public SameWordsListener() {
        ob = new SameWords();
    }

    public SameWordsListener(String flag) {
        ob = new SameWords();
        this.flag = flag;
    }

    public SameWordsListener(SameWords ob) {
        this.ob = ob;
    }

    @Override
    public void invoke(SameWords data, AnalysisContext context) {
