...
@SpringBootTest
@Feature("自研打断")
public class ZyAsrBreak extends BaseOfTestCase {
    ...
    @MValue("break.account")
    private String account;

    @MValue("break.pwd")
    private String pwd;

    @MValue("break.zyAsr_TaskRobotID")
    ...
    public void setUp() {
        ...
        this.taskName = "zy-" + TimeUtil.getNowTime("yyyyMMddhhmmss") + "-" + robotUtil.getRandomDataByLen(6);
        //外呼任务为手动外呼任务
        this.taskType = 1;
...
//        }
        ...
        Assert.assertTrue(type0content2.contains("我不清楚"));
